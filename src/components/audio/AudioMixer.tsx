...
export function AudioMixer() {
  ...
  const ttsTemperature = useSpeechStore((s) => s.ttsTemperature)
  const setTtsTemperature = useSpeechStore((s) => s.setTtsTemperature)
  ...
  return (
    <div className="space-y-1">
      ...
      {/* Expressiveness — only when TTS is enabled */}
      {speechEnabled && (
        <>
